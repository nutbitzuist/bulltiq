...
try {
    const parts = [
        'scripts/batch22-analyses.js',
        'scripts/temp_batch22_part2.js',
        'scripts/temp_batch22_part3.js',
        'scripts/temp_batch22_part4.js'
    ];
...
${combinedParts.join('\n')}
    ...
    fs.writeFileSync('scripts/batch22-analyses.js', finalContent);
    console.log('Successfully assembled scripts/batch22-analyses.js');
