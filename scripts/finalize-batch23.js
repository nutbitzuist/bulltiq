...
try {
    const parts = [
        'scripts/batch23-analyses.js',
        'scripts/temp_batch23_part2.js',
        'scripts/temp_batch23_part3.js',
        'scripts/temp_batch23_part4.js'
    ];
...
${combinedParts.join('\n')}
    ...
    fs.writeFileSync('scripts/batch23-analyses.js', finalContent);
    console.log('Successfully assembled scripts/batch23-analyses.js');
